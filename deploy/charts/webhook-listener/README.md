...
| config.launcher | object | `{"cloneDepth":0,"gitSecretPath":"/etc/pipeManager/git-credentials","imageName":"k3d-registry:5111/pipeline-converter","jobNamePrefix":"pipeline-launcher","namespace":"","pullPolicy":"IfNotPresent","tag":"0.0.2","timeout":600}` | Configuration for Pipeline Launcher |
